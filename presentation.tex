...
\begin{frame}[fragile]{Ist-Analyse}
  ...
  \begin{itemize}
    \item Paketgröße und Anzahl wird manuell gepflegt
          \note<1->[item]{Paketgröße und Anzahl wird manuell gepflegt}
          \pause
    \item Neue Anforderungen durch  Verpackungsgesetz
          \note<2->[item]{Es gibt neue Anforderungen durch  Verpackungsgesetz}
          \pause
    \item Hoher Wartungsaufwand für pflegende Personen
          \note<3->[item]{Hoher Wartungsaufwand}
          \pause
    \item Paketgröße ungenau
          \note<4->[item]{Berechnete Paketgröße stimmt nicht mit eigentlichem Paket ueber ein}
  \end{itemize}
\end{frame}
