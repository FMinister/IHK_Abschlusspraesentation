...
\begin{frame}[fragile]{Implementierung der Sensor-Abfrage}
  \begin{lstlisting}[style=sql-style,
    breaklines=true, firstnumber=44]
  void loop() {<@\\\large\vdots \setcounter{lstnumber}{58}@>
    ...
    receiveComplete1 = false;<@\\\large\vdots \setcounter{lstnumber}{89}@>
  }
\end{lstlisting}
\end{frame}
...
\begin{frame}[fragile]{Implementierung des Ausleseservice}
  \textbf{HIER DIAGRAMM ERSTELLEN UND EINFÜGEN}
\end{frame}
...
\begin{frame}[fragile]{Erkennung der Versandverpackung}
  \textbf{Verwendete Pakete}
  \begin{itemize}
    \item Python
    \item numpy
